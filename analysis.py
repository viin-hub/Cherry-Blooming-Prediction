...
list_washingtondc1 = list_washingtondc.astype(int)
list_kyoto1 = list_kyoto.astype(int)
list_liestal1 = list_liestal.astype(int)
list_vancouver1 = list_vancouver.astype(int)

data_merged_pred = {"year": year_to_predict, "kyoto": list_kyoto1, "liestal": list_liestal1,\
    "washingtondc": list_washingtondc1, "vancouver": list_vancouver1}
